...
function bedsUnderSpecificRoomsDisplay(roomNumber){
  ...
  console.log("current_beds",current_beds);
  
    var to_hide="";
    console.log("hide",typeof(beds_array));
...
var strings,room_n,floor_n,beds_n;
for(var at=0;at<beds_array.length;at++)
{
beds_n=beds_array[at];
strings=beds_array[at].split("_");
room_n=strings[0];
floor_n= parseInt(room_n / 100);
console.log("floor_no=",floor_n);
console.log("room_no=",room_n);
console.log("beds_no=",beds_n);
}
</script>
