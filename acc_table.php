            ...
            <div class="row h-90 justify-content-center align-items-center">
                <div class="col-10 col-md-8 col-lg-6" style="  border-style: solid;border-width: 3px;border-radius: 20px;
                 padding: 20px;box-shadow: 5px 10px #76D7C4;">
					<!-- Form -->
                    <a href="account.php"  > <div style="margin-left:430px">
                    <button id='closeModal' type="button" class="btn btn-danger" data-dismiss="modal">Close</button></div></a>   
                	<form class="form-example" action="account.php" method="post">
                     <h1><center><div class="p-3 mb-2 bg- text-black"><p class="two">Add Income Details</p></div></center></h1>
                		
                		<!-- Input fields -->
                        <div class="form-group">
                			<label for="username">Income Types:</label>
                			<input type="text" class="form-control username" id="username" placeholder="" name="username">
                		</div>
                		<div class="form-group">
                			<label for="JoiningDate">Date :</label>
                			<input type="date" class="form-control JoiningDate" id="JoiningDate" placeholder="" name="JoiningDate">
                		</div>
						<div class="form-group">
							<label for="password">Amount :</label>
							<input type="text" class="form-control number" id="bed number" placeholder="" name="number">
