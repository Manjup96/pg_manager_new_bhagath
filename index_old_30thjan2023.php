...
form.addEventListener('submit', function(e){
 ...
 fetch('https://iqbetspro.com/pg-management/loginapi.php', {
  method: 'POST',
  body: JSON.stringify({
    property_email:username,
    password:password,
  ...
  {console.log(typeof(data[0].Message));
    ...
    {
      var manager = {};
      manager.username = data[0].Message.property_name;
      manager. email = data[0].Message.property_email;
      manager.mobile = data[0].Message.property_phone;
      console.log(manager)
      // alert("OK");
        $.ajax({
            url: 'set_session.php',
