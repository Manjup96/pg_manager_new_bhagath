				...
				border-radius: 20px;
                 padding: 20px;box-shadow: 5px 10px #76D7C4;">
                    ...
                    <div id="tenantDetails" style="display:none">
						...
						<center><button type="submit" id="submit" class="btn btn-success btn-customized">Save</button>
						</center>
                		<!-- End input fields -->
...
form.addEventListener('submit', function(e){
 ...
 var tenantUsername = document.getElementById("tenantUserName").value;
    ...
    console.log(building_name,managerEmail,managerMobile,tenantUsername,tenantMobileNumber,tenantEmail,tenantJoiningDate,
    tenantComments,floor_no,bed_no,room_no,total_amount,payAmount);
...
//bro once we see is that ok - 5 mins i vl come again ok bro sry i kept these details in update api
  }),
  headers: {
...
<script>
      const url_get_tenant_details="https://iqbetspro.com/pg-management/GET-tenant-with-manager-email-API.php";
