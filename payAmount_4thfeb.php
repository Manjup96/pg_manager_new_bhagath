                 ...
                 padding: 20px;box-shadow: 5px 10px #76D7C4;">
                    ...
                    <div id="tenantDetails" style="display:none">
                        ...
                        <div class="form-group">
                			...
                			<input type="number" class="form-control amount" id="pay_amount" placeholder="" value="<?php echo $total_amount;?>" name="pay_amount" disabled>
                		</div>
                          <div class="form-group">
...
form.addEventListener('submit', function(e){
 e.preventDefault()
     var tenant_name = document.getElementById("tenantUserName").value;
 ...
 fetch('https://iqbetspro.com/pg-management/update-bed-deatils-while-assiging-bed-to-tenant.php', {
  ...
  body: JSON.stringify({
    "pg_manager_email":"pgm1@gmail.com",
            ...
            //"tenant_name":"test_in_payamount_php",
