                 ...
                 padding: 20px;box-shadow: 5px 10px #76D7C4;">
                    ...
                    <h1><center><div class="p-3 mb-2 bg- text-black" ><p class="two">Adding Bed Details</p></div></center></h1>
                        ...
                        <div class="form-group">
                			...
                			<input type="number" class="form-control roomFloorNumber" id="roomFloorNumber" placeholder="" name="roomFloorNumber">
                		</div>
                		<div class="form-group">
                			<label for="roomRoomNumber">Room Number :</label>
                			<input type="number" class="form-control roomRoomNumber" id="roomRoomNumber" placeholder="" name="roomRoomNumber">
                		</div>
						<div class="form-group">
							<label for="roomBedNumber">Bed Number :</label>
							<input type="number" class="form-control roomBedNumber" id="roomBedNumber" placeholder="" name="roomBedNumber">
						</div>
                        <div class="form-group">
							<label for="roomRoomSharing">Room Sharing :</label>
							<input type="number" class="form-control roomRoomSharing" id="roomRoomSharing" placeholder="" name="roomRoomSharing">
						</div>
                        <div class="form-group">
                			<label for="roomPrice">Price:</label>
                			<input type="number" class="form-control roomPrice" id="roomPrice" placeholder="" name="roomPrice">
                		</div>
