          ...
          <form name="form" id="form" >
                   ...
                   <div class="form-group">
                    ...
                    <div><label for="tenantComments">Comments</label>
                      ...
                      <br>
						<center>
              <button type="submit" class="btn btn-success btn-customized" id="save_tenant" >Save</button>
                             </center>
...
form.addEventListener('submit', function(e){
 e.preventDefault()
     ...
     var managerMobile = document.getElementById("manager_mobile").value;
      ...
      console.log(managerMobile,managerEmail,tenantMobileNumber,tenantUsername,tenantEmail,tenantJoiningDate,tenantComments,tenantAdharCardNumber);
